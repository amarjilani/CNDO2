...
void SCF(std::vector<AO> &MoleculeAOs, std::vector<int> atoms,  arma::mat &OV_mat, arma::mat &G_mat, arma::mat &H_core, arma::mat &P_alpha, arma::mat &P_beta, arma::mat &F_alpha, arma::mat &F_beta, int p, int q, int valence_elec);
